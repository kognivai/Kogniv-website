      ...
      <section className="relative pt-44 pb-28 overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl font-semibold text-foreground leading-snug mb-6"
          >
            We built the intelligence layer ServiceNow was missing. Then we use it to transform your enterprise.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 gap-px bg-border/40 border border-border/40 rounded-2xl overflow-hidden">
            {[
              ...
              },
              {
                ...
                body: "We don't configure off-the-shelf tools. We build KAFE — Kogniv Agentic AI Factory for Enterprises — purpose-engineered to design, deploy, and continuously improve AI agents across your enterprise workflows.",
              },
              {
                eyebrow: "03",
