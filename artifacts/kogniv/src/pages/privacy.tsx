...
const sections = [
  ...
  },
  {
    ...
    body: [
      "We use the information you provide to respond to your inquiries, schedule discovery calls, deliver consulting services, and send you updates about Kogniv, KAFE (Kogniv Agentic AI Factory for Enterprises), and relevant industry insights you have opted into.",
      ...
      <section className="py-12">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          <motion.p {...fadeUp} className="text-muted-foreground leading-relaxed text-lg">
            Kogniv LLC ("Kogniv," "we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or engage with our services. Please read this policy carefully. If you disagree with its terms, please discontinue use of the site.
          </motion.p>
        </div>
      </section>
