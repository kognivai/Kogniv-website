...
const sections = [
  ...
  },
  {
    ...
    body: [
      "All content on this Site — including but not limited to text, graphics, logos, images, and software — is the property of Workwayz LLC DBA Kogniv and is protected by applicable intellectual property laws. You may not reproduce, distribute, modify, create derivative works of, publicly display, or commercially exploit any content from this Site without our prior written consent.",
      "The KAFE (Kogniv Agentic AI Factory on NOW) brand, methodology, and related technology are proprietary to Workwayz LLC DBA Kogniv. No license or right to use any Kogniv trademark is granted by these Terms.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      "To the fullest extent permitted by applicable law, Workwayz LLC DBA Kogniv and its officers, directors, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages — including loss of profits, data, goodwill, or other intangible losses — arising out of or in connection with your use of, or inability to use, this Site or its content.",
      ...
      <section className="py-12">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          <motion.p {...fadeUp} className="text-muted-foreground leading-relaxed text-lg">
            These Terms of Service ("Terms") govern your access to and use of the website operated by Workwayz LLC DBA Kogniv ("Kogniv," "we," "our," or "us"). Please read these Terms carefully before using our Site. By accessing this Site, you confirm that you have read, understood, and agree to be bound by these Terms.
          </motion.p>
        </div>
      </section>
